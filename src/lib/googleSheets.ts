...
export const HEADER_ALIASES: Record<string, string> = {
  ...
  ward: "Ward",
  a3b_select_the_ward: "A3b. Select the Ward",
  interviewer_number: "A1. Enumerator ID",
  ...
  a5_gps_coordinates: "A5. GPS Coordinates",
  gpscoordinates: "A5. GPS Coordinates",
  consent: "A6. Consent to participate",
  "a6_consent_to_participate": "A6. Consent to participate",
  ...
  // QC Flag mappings
  qc_flag_low_loi: "QC_FLAG_LOW_LOI",
  qc_flag_high_loi: "QC_FLAG_HIGH_LOI",
  qc_flag_odd_hour: "QC_FLAG_ODD_HOUR",
  qc_flag_short_gap: "QC_FLAG_SHORT_GAP",
  qc_flag_interwoven: "QC_FLAG_INTERWOVEN",
  qc_flag_clustered_interview: "QC_FLAG_CLUSTERED_INTERVIEW",
  qc_flag_duplicate_phone: "QC_FLAG_DUPLICATE_PHONE",
  qc_flag_duplicate_gps: "QC_FLAG_DUPLICATE_GPS",
  qc_flag_outside_lga_boundary: "QC_FLAG_OUTSIDE_LGA_BOUNDARY",
  qc_flag_count: "QC_FLAG_COUNT",
  qc_issues: "QC Issues",
};
